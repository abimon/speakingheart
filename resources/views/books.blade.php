    ...
    <div class="container py-5">
      ...
      <div class="col-lg-4 col-md-6 wow fadeInUp h-100 mb-2">
        <div data-wow-delay="0.3s">
          <embed src="{{asset('storage/books/'.$book->path)}}" alt="" style="width: 100%; height: 40vh; object-fit: cover;">
        </div>
        <div class="price-item" data-wow-delay="0.5s">
          <div class="border-bottom p-4 mb-4 h-100">
            <h5 class="text-primary mb-1 overflow-hidden text-uppercase" ><?php echo substr($book->title,0,35)?>...</h5>
