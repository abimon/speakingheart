...
<div class="container h-100 card p-3">
    <form action="{{route('poems.update',$post->id)}}" method="post" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="d-flex justify-content-center">
            <div class="col-md-6 mb-3">
                ...
                <div class="m-3 card p-3 border-dark bg-transparent" style="border-style:dashed;">
                    <img id="out" src="{{asset('storage/articles/' . $post->cover)}}"
        ...
        <div class="form-check">
            <input class="form-check-input" type="checkbox" value="1" {{$post->isPosted ? 'checked' : ''}}
                name="isPosted">
